                            ...
                            foreach ($kategori as $kategori) {
                                echo "<tr>
                                    ...
                                    <div>
                                        ...
                                        <a href=" . base_url('kategori/delete/' . $kategori->id) . " class='btn btn-sm btn-danger' onclick='return confirm(\"Ingin menghapus data ini?\");'><i class='fas fa-trash'></i>Hapus</a>
                                        </div>
                                    </td>
                                    </tr>";
                                $no++;
